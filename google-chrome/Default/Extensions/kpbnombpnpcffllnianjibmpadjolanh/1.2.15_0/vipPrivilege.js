!function(s) {
    function e(e) {
        ...
        Object.prototype.hasOwnProperty.call(r, a) && r[a] && f.push(r[a][0]), r[a] = 0;
        for (t in l) Object.prototype.hasOwnProperty.call(l, t) && (s[t] = l[t]);
        for (i && i(e); f.length; ) f.shift()();
        return n.push.apply(n, u || []), j();
    }
    function j() {
        for (var s, e = 0; e < n.length; e++) {
            for (var j = n[e], t = !0, o = 1; o < j.length; o++) {
                var l = j[o];
                0 !== r[l] && (t = !1);
            }
            t && (n.splice(e--, 1), s = a(a.s = j[0]));
        }
        return s;
    }
    var t = {}, r = {
    ...
    204: function(s, e, j) {
        ...
        }, r.resolve = n, s.exports = r, r.id = 204;
    },
    888: function(s, e, j) {
        "use strict";
        j.r(e), new (j(175).a)("vipPrivilege");
    }
});