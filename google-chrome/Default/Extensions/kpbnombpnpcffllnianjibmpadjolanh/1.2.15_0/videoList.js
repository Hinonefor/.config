!function(s) {
    function e(e) {
        for (var t, a, o = e[0], u = e[1], l = e[2], c = 0, f = []; c < o.length; c++) a = o[c], 
        Object.prototype.hasOwnProperty.call(n, a) && n[a] && f.push(n[a][0]), n[a] = 0;
        for (t in u) Object.prototype.hasOwnProperty.call(u, t) && (s[t] = u[t]);
        for (i && i(e); f.length; ) f.shift()();
        return r.push.apply(r, l || []), j();
    }
    function j() {
